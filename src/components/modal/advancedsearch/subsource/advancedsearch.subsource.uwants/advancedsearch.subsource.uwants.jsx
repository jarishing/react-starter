...
import View from './advancedsearch.subsource.uwants.view';
import Model from './advancedsearch.subsource.uwants.model';

import * as searchAction from '../../../../../reducers/search/action';

class AdvancedSearchSubsourceUwants extends Component {
...
export default connect( mapStateToProps, mapDispatchToProps )(AdvancedSearchSubsourceUwants);