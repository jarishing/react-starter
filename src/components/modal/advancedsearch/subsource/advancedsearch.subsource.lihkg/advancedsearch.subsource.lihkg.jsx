...
import View from './advancedsearch.subsource.lihkg.view';
import Model from './advancedsearch.subsource.lihkg.model';

import * as searchAction from '../../../../../reducers/search/action';

class AdvancedSearchSubsourceLihkg extends Component {
...
export default connect( mapStateToProps, mapDispatchToProps )(AdvancedSearchSubsourceLihkg);