...
import View from './advancedsearch.subsource.hkdiscuss.view';
import Model from './advancedsearch.subsource.hkdiscuss.model';

import * as searchAction from '../../../../../reducers/search/action';

class AdvancedSearchSubsourceHkdiscuss extends Component {
...
export default connect( mapStateToProps, mapDispatchToProps )(AdvancedSearchSubsourceHkdiscuss);