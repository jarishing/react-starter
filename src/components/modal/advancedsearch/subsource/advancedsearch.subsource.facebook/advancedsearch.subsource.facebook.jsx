...
import View from './advancedsearch.subsource.facebook.view';
import Model from './advancedsearch.subsource.facebook.model';

import * as searchAction from '../../../../../reducers/search/action';

class AdvancedSearchSubsourceFacebook extends Component {
...
export default connect( mapStateToProps, mapDispatchToProps )(AdvancedSearchSubsourceFacebook);